...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Sí, EmotionSEO está capacitado para escribir y analizar emociones en más de 30 idiomas, manteniendo un alto nivel de precisión y relevancia cultural en cada uno.",
  },
  {
  ...
  {
    question:
      "• ¿Cómo se diferencia EmotionSEO de otras herramientas de generación de contenido?",
    answer:
...
const FAQ = () => {
  return (
    <div className="w-full flex flex-col justify-center items-center pb-24 ">
      <div className="text-white text-[2.5rem] pb-5">Frequent questions</div>
      {faqItems.map((item) => (
        <Dropdown item={item} />
      ))}
    </div>
